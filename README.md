Due to the fact that Ansible project have greate and growing community almost any task can solved using predefined and adopted playbooks and roles created and provided by this community public access.
